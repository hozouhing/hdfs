...
public class BaseServiceImpl<T> implements BaseService<T> {
    ...
    @Override
    public Page<T> selectByPage(T condition, PageQo pageQo) {
        return this.selectByPage(condition, pageQo.getPageNum(), pageQo.getPageSize(),
            pageQo.getOrderBy());
    }

    @Override
    public Page<T> selectByPage(PageQo pageQo) {
        return null;
    }
}
